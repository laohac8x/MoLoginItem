#
# Be sure to run `pod lib lint MoLoginItem.podspec' to ensure this is a
...
s.name             = 'MoLoginItem'
s.version          = '1.0'
s.summary          = 'A short description of MoLoginItem.'
...
s.homepage         = 'https://github.com/laohac8x/MoLoginItem'
